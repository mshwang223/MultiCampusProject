...
$(document).ready(function() {
	...
	$('#imgBox img').animate({ 'top': 0 }, 2000);
	$('#text1 h1').delay(1500).animate({ 'left': 0 }, 1000);
	$('#text1 h3').delay(2000).animate({ 'left': 0 }, 1000);
	$('#text1 h5').delay(2500).animate({ 'left': 0 }, 1000);
	$('#text2 h1').delay(3000).animate({ 'top': 0 }, 1000);
	$('#text3 h1').delay(3500).animate({ 'left': 0 }, 1000);
	$('#text3 h3').delay(4000).animate({ 'left': 0 }, 1000);
	$('#text3 h4').delay(4500).animate({ 'left': 0 }, 1000);
	...
	let subText1_2 = document.getElementById("subText1_2");
	let subText2 = document.getElementById("subText2");
	let subText2_2 = document.getElementById("subText2_2");
	let subText3 = document.getElementById("subText3");
	let subText3_2 = document.getElementById("subText3_2");
